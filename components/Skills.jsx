...
const Skills = () => {
  return (
    ...
    <p className='hidden md:flex uppercase text-2xl text-center tracking-widest pt-12 pb-12 pl-12 pr-14 text-2xl font-normal text-white bg-gradient-to-r from-rose-400 via-fuchsia-500 to-indigo-500'>
            SKILLS
    </p>
      ...
      <p className='md:hidden uppercase text-2xl text-center tracking-widest pt-0 pl-4'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-4 gap-8 p-20 pt-24 pt-24 rounded-3xl pl-12'> 
            {skills && skills.map ( n => ( 
              <div key={n.id} className='cursor-pointer p-6  bg-[#ffff] rounded-3xl group hover:text-white hover:bg-gradient-to-r from-rose-400 via-fuchsia-500 to-indigo-500 ease-in duration-300 hover:scale-105 ease-in duration-300'>
