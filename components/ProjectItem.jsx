...
function Icons(props) {
  ...
  if (Icon == 1) {
    return (
      ...
      <a
                    ...
                    rel='noreferrer'
                  >
                    <div className='rounded-full p-2 cursor-pointer hover:scale-110 ease-in duration-300 hover:text-[#ffff] ease-in duration-300'>
  ...
  if (Icon == 2){
  return <div>
    <div className='hidden group-hover:block absolute top-[70%] left-[55%] translate-x-[-50%] translate-y-[-50%]'>
    ...
    <div className='hidden group-hover:block absolute top-[70%] left-[45%] translate-x-[-50%] translate-y-[-50%]'>
  ...
  return (
    ...
    <div className='hidden group-hover:block absolute top-[30%] left-[50%] translate-x-[-50%] translate-y-[-50%]'>
      <h3 className='text-xl font-light text-gray-100 tracking-wider text-center'>{title}</h3>
    </div>
 
    <Icons Icon={icon}/>

    <div className='hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]'>
                <p className='text-center text-gray-100'>{tech}</p>
    </div>
